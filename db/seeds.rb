...
my_option = Option.create(detail:"section detail", range:"134x41 / 136x42 / 138x43", fin: "3,5cm",stance: "62cm / 65cm / 68cm",champs: "HRD", weigh: rand(3.2..4.8), carene: "channel", flex:"medium", velcros: rand(1..4))
